...
if($_SESSION["level"]==1 or $_SESSION["level"]==2 or $_SESSION["level"]==7)
{
?>
<HTML>
<HEAD>
<TITLE>Men&uacute; de Actualizaci&oacute;n Jornadas. Sistema ARTS Online</TITLE>
...
.Estilo37 {color: #FF9900}
.Estilo38 {font-size: 16px; color: #FF9900; font-weight: bold; }
-->
...
<table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFAFA">
  ...
  <p class="Estilo35"><font color="#009900"><em><strong>Crear Plantillas </strong></em></font></p>
  ...
  <form action="dirigir_crear_plantilla.php" name="sampleform" onSubmit="MM_validateForm('fecha','','R','ci','','RisNum');return document.MM_returnValue;enviar()">
    <table width="463" height="153" border="1" id="tablaA">
      <tr>
        <td width="453" height="147"><div align="center">
          <p align="left" class="Estilo38">Seleccione una opci&oacute;n: </p>
          <table width="289" height="43" border="1">
              <tr>
                <td width="137" height="16" class="t12g">Por d&Iacute;a </td>
                <td width="136" class="Estilo58"><div align="center" class="Estilo56">
                  <label>
                  <input name="plantilla" type="radio" value="1">
                  </label>
                </div>			   </tr>
              <tr>
                <td height="21" class="t12g">por semana </td>
                <td class="Estilo58"><div align="center" class="Estilo56">
                  <label>
                  <input name="plantilla" type="radio" value="2">
                  </label>
                </div></td>
              </tr>
            </table>
          <table width="210" border="0">
              <tr>
                <td width="100" class="Estilo40"><div align="center" class="Estilo68">
                    <input name="Submit12" type="submit" style="background:#FFB400" lang="es" onClick="MM_validateForm('fecha','','R','ci','','RisNum');return document.MM_returnValue" value="Enviar">
                </div></td>
                <td width="100" class="Estilo40"><div align="center" class="Estilo68">
                    <input name="Reset22" type="reset" id="Reset22" value="Limpiar" style="background:#FFB400">
                </div></td>
              </tr>
            </table>
        </div></td>
