...
<form name="carga_traba" action="verifica_ci_consulta_traba.php" method="post" enctype="multipart/form-data"  id="carga_traba">
  <h3 class="Estilo29">Consulta </h3>
  <h3 class="Estilo29">de Trabajadores</h3>
  <p class="Estilo28">&nbsp;</p>
  <table width="309" height="56" border="6" class="t12g">
    <tr>
      <td width="182" height="28">C&Eacute;dula de Identidad </td> 
      <td width="117" height="28"><div align="center">
        <input name="ci" type="text" id="ci" size="15" maxlength="15" onKeyPress="mis_datos()">
      </div></td>
      </tr>
  </table>
  <p>&nbsp;</p>
  <table width="387" border="0">
    <tr>
      <td width="129" height="46"><div align="center">
          <label>
          <input name="Submit" type="submit" style="background:#FFB400" lang="es" onClick="MM_validateForm('ci','','RisNum');enviar();return document.MM_returnValue" value="Enviar">
          </label>
      </div></td>
      <td width="119"><div align="center">
          <label>
          <input name="reset" type="reset" id="reset" value="Restablecer" style="background:#FFB400" lang="es">
          </label>
      </div></td>
...
<h1 align="right"><table width="47%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <div align="center"><span class="t12g">
        </span>
	    <p><span class="t12w">Sistema ARTS</span></p>
	  </div>
      <ul>
        <li><span class="t12w"><a title="inicio.htm" href="inicio.html" target="_top">Inicio</a></span></li>
        <li><span class="t12w"><a title="antecedentes.htm" href="antecedentes.htm" target="_top">Antecedentes</a></span></li>
        <li><span class="t12w"><a title="Objetivos.html" href="Objetivos.html" target="_top">Objetivos</a></span></li>
        <li><span class="t12w">Trabajadores 
          
          
            </span>
          <ul>
              <li><span class="t12w"><a title="cargar_traba.php" href="cargar_traba.php" target="_self">Inclusion - Carga</a></span></li>
                <li><span class="t12w"><a title="consulta_trabaj.php" href="consulta_trabaj.php" target="_self">Consulta - Reporte</a></span></li>
                <li><span class="t12w"><a title="actualizar_trabaj.php" href="actualizar_trabaj.php" target="_self">Modificacion</a></span></li>
                <li><span class="t12w"><a title="elim_traba.php" href="elim_traba.php" target="_self">Eliminacion</a></span></li>
                <li><span class="t12w"><a title="menu_graficar_trabaj.php" href="menu_graficar_trabaj.php" target="_self">Graficacion</a></span></li>
              </ul>
        </li>
        <li><span class="t12w">Jornadas 
          
          
            </span>
          <ul>
              <li><span class="t12w"><a title="cargar_jornada.html" href="cargar_jornada.php" target="_self">Inclusion - Carga</a></span></li>
                <li><span class="t12w"><a title="consulta_jornada.php" href="consulta_jornada.php" target="_self">Consulta - Reporte</a></span></li>
                <li><span class="t12w"><a title="actualizar_jornada.php" href="actualizar_jornada.php" target="_self">Modificacion</a></span></li>
                <li><span class="t12w"><a title="delete_jornada.php" href="delete_jornada.php" target="_self">Eliminacion</a></span></li>
                <li><span class="t12w"><a title="menu_graficar_jornada.php" href="menu_graficar_jornada.php" target="_self">Graficacion</a></span></li>
              </ul>
        </li>
        <li><span class="t12w">Menu Admin
          
          
            </span>
          <ul>
              <li><span class="t12w"><strong>Trabajadores</strong>
                ...
                <li><span class="t12w"><strong>Usuarios </strong>
                  
                  </span>
                  <ul>
                    <li><span class="t12w"><a title="cargar_user.php" href="cargar_user.php" target="_self">Inclusion - Carga</a></span></li>
                    <li><span class="t12w"><a title="consulta_user.php" href="consulta_user.php" target="_self">Consulta - Reporte</a></span></li>
                    <li><span class="t12w"><a title="actualizar_user.php" href="actualizar_user.php" target="_self">Modificacion</a></span></li>
                    <li><span class="t12w"><a title="elim_user.php" href="elim_user.php" target="_self">Eliminacion</a></span></li>
                    <li><span class="t12w"><a title="menu_graficar_user.php" href="menu_graficar_user.php" target="_self">Graficacion</a></span></li>
                  </ul>
                </li>
                <li><span class="t12w"><a title="consulta_jornada.php" href="consulta_jornada.php" target="_self">Consulta - Reporte</a></span></li>
                <li><span class="t12w"><a title="actualizar_jornada.php" href="actualizar_jornada.php" target="_self">Modificacion</a></span></li>
                <li><span class="t12w"><a title="elim_jornada.php" href="elim_jornada.php" target="_self">Eliminacion</a></span></li>
              </ul>
        </li>
        <li><span class="t12w"><a title="download.html" href="download.html" target="_self">Descargas</a></span></li>
        <li><span class="t12w"><a href="menu_sarts.html">Sistema ARTS </a></span></li>
        <li><span class="t12w">Contacto SARTS</span></li>
        <li><span class="t12w">FAQ 
          
          
            </span>
          <ul>
              <li><span class="t12w">Preguntas Generales</span></li>
                <li><span class="t12w">Manual de Usuario</span></li>
              </ul>
        </li>
        <li><span class="t12w">Ayuda Online (proximamente)</span></li>
        <li><span class="t12w">Forums (proximanete)</span></li>
        <span class="Estilo9 Estilo29"></span>
      </ul>
      <div align="left">
