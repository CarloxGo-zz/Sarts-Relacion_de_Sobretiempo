...
$result = mysql_query("select * from traba where estructura='$estructura' and estatus=2 order by estructura");

?>
</h2>
<form name="form2" method="post" action="">
  <h2 class="t12b Estilo2"><em><strong><font color="#009900">Consulta de Trabajadores </font></strong></em></h2>
