...
if ($_GET['error']==1){
	...
	echo 'alert( "No escribio correctamente la fecha, segun el formato dado. Por favor corrijalo");';
	echo '</script>';
}
if ($_GET['error']==2){
	echo '<script LANGUAGE="JavaScript">';
	echo 'alert( "No selecciono ningun departamento. Por favor verifique su opcion");';
	echo '</script>';
}
?>
</HEAD>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFAFA">
  ...
  <p class="Estilo35"><font color="#009900"><em><strong>Relacionar Jornada</strong></em></font></p>
   ...
   <table width="420" height="170" border="1" id="tablaA">
    <tr>
      <td width="377" height="164"><div align="center">
            <p align="center" class="Estilo32 Estilo45"><strong>Por Jornada</strong></p>
            <table width="403" height="40" border="1" id="tablatar1">
              <tr>
                <td width="228" height="36" class="t12g">FECHA DE INICIO (DD/MM/AAAA)</td>
                <td width="139" class="Estilo59" ><div align="center">
                	<input name="fecha_jornada_grupo" type="date" required="required">
                	
                  </div></td>
              </tr>
            </table>
            <table width="408" height="34" border="0" id="tablatar2">
              <tr>
                <td width="167" height="30" class="t12g">GRUPO DE TRABAJO </td>
                <td width="208" class="Estilo59"><div align="center">
                    <table id="tabla0"  width="200" border="0">
                      <tr>
                        <td><div align="center" class="t12g">
                            <strong>
                            <select name="grupo_inc_jornada" class="Estilo56">
                              <?php
...
?>
			...
			<p class="t12g">
              <input name="llenado_jornada" type="radio" value="1" checked="checked">Sin plantillas 
			  <input name="llenado_jornada" type="radio" value="2" onClick="viewHide('plantilla_jornada')">Con Plantillas
										</p>
										<?php
										$cuentam=$_COOKIE['usuario'];
										echo '<input name="cuenta" type="hidden" value="'.$_COOKIE['usuario'].'">';
										?>
										<table width="370" border="0" id="plantilla_jornada" style="display:none">
                                        <tr>
			...
			<table width="210" border="0">
              <tr>
                <td width="100" class="comment"><div align="center" class="Estilo69">
                    <input name="Submit2" type="submit" style="background:#FFB400" lang="es" onClick="MM_validateForm('fecha_tarjeta_grupo1','','R');return document.MM_returnValue" value="Enviar">
                        </div></td>
                <td width="100" class="comment"><div align="center" class="Estilo69">
...
<form action="inc_semana_grupo.php" method="post" name="sampleform2" onSubmit="MM_validateForm('fecha','','R','ci','','RisNum');return document.MM_returnValue">
					        <table width="418" height="162" border="1" id="tablaA">
                              <tr>
                                <td width="377" height="156"><span class="t12g Estilo41">
                                  ...
                                  <div align="center">
                                      <table width="403" height="28" border="1" id="tablatar1">
                                        <tr>
                                          <td width="228" height="24" class="t12g">FECHA DE INICIO (DD/MM/AAAA)</td>
                                          <td width="139" class="Estilo45"><div align="center" class="Estilo53">
                                          <input name="fecha_semana_grupo" type="date" required="required">
                                          </div></td>
                                        </tr>
                                      </table>
                                      <table width="386" height="34" border="0" id="tablatar2">
                                        <tr>
                                          <td width="168" height="30" class="t12g">GRUPO DE TRABAJO </td>
                                          <td width="208"><div align="center" class="Estilo56">
                                              <table id="tabla0"  width="200" border="0">
                                                <tr>
                                                  <td><div align="center">
                                        <select name="grupo_inc_semana" class="Estilo56">
										<?php
$tablaestructura = mysql_query("SELECT * FROM estructura WHERE nivel=1 ORDER BY estruc ASC");
while ($registroestructura = mysql_fetch_array($tablaestructura))
{
...
?>
                                      ...
                                      <p class="t12g">
                                        <input name="llenado_semana" type="radio" value="1" checked="checked">
                                        sin plantillas
  <input name="llenado_semana" type="radio" value="2" onClick="viewHide('plantilla_semana')">
                                        con Plantillas
										</p>
										<?php
										$cuentam=$_COOKIE['usuario'];
										echo '<input name="cuenta" type="hidden" value="'.$_COOKIE['usuario'].'">';
										?>
										<table width="370" border="0" id="plantilla_semana" style="display:none">
                                        <tr>
                                          <td width="180" class="t12g" > Plantilla a seleccionar</td>
                                          <td width="180"><div align="left">
                                      ...
                                      <table width="222" border="0">
                                        <tr>
                                          <td width="108" class="Estilo71"><div align="center" class="Estilo68" onfocus="MM_validateForm('fecha_tarjeta_grupo2','','R');return document.MM_returnValue">
                                            <input name="Submit3" type="submit" style="background:#FFB400" lang="es" onClick="MM_validateForm('fecha_tarjeta_grupo2','','R');return document.MM_returnValue" value="Enviar">
                                          </div></td>
