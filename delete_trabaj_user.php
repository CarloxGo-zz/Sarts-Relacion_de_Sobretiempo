...
function enviar(){
var enviarme=confirm("¿Desea Eliminar este trabajador?");
if (enviarme)
   return true ;
else
   return false ;
	...
	<td width="481" align="right" bgcolor="#FFFFFF"> 
	  ...
	  <table width="535" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="507" valign="top" class="bg_product"><table width="526" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="508" bgcolor="#FFFFFF" class="t12b"><table width="101%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="471" align="center" bgcolor="#FFFFFF"><p>&nbsp;</p>
                          <div align="center">
                            <p><em><strong><font color="#009900">Men&uacute; de Usuarios</font></strong></em></p>
                            <p><em><strong><font color="#009900">Eliminaci&oacute;n de Trabajadores </font></strong></em></p>
                                      ...
                                      <table width="315" height="54" border="0">
                                        <tr>
                                          ...
                                          <td width="144"><div align="center">
                                              <input name="ci" type="text" id="ci" size="11" maxlength="9">
                                          </div></td>
                                        </tr>
                                        <tr>
                                          <td><div align="center">
	...
	<td width="297" valign="top" background="images/index_32.gif">
      ...
      <ul class="Estilo9">
        ...
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Trabajadores 
          ...
          <ul>
              <li><span class="Estilo28"><a title="cargar_traba.php" href="cargar_traba.php" target="_self">Inclusion - Carga</a></span></li>
              <li><span class="Estilo28"><a title="consulta_trabaj.php" href="consulta_trabaj.php" target="_self">Consulta - Reporte</a></span></li>
        ...
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Jornadas 
          ...
          <ul>
              <li><span class="Estilo28"><a title="cargar_jornada.html" href="cargar_jornada.php" target="_self">Inclusion - Carga</a></span></li>
        ...
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Menu Admin
          ...
          <ul>
              ...
              <li><span class="Estilo28"><strong>Usuarios </strong>
                ...
                <ul>
                    <li><span class="Estilo28"><a title="cargar_user.php" href="cargar_user.php" target="_self">Inclusion - Carga</a></span></li>
                    <li><span class="Estilo28"><a title="consulta_user.php" href="consulta_user.php" target="_self">Consulta - Reporte</a></span></li>
