...
<table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFAFA">
  ...
  <p class="Estilo35"><font color="#009900"><em><strong>Modificar Plantillas </strong></em></font></p>
  <p class="Estilo35"><span class="Estilo36"><font color="#009900"><em><strong>Datos de entrada</strong></em></font></span></p>
  <p class="Estilo35">&nbsp;</p>
  <table width="434" border="1">
   <tr>
     <td width="433"><div align="center">

<!-- MODIFICAR JORNADA POR JORNADA--> 

<form action="mod_plantilla_jornada.php" method="post" name="form1" onSubmit="MM_validateForm('fecha','','R','ci','','RisNum');return document.MM_returnValue">
      ...
      <td width="377" height="164"><div align="center">
            ...
            <p class="t12g">
              <?php
				...
				echo '<input name="llenado_semana" type="hidden" value=2>';
				?></p>
				<table width="370" border="0" id="plantilla_jornada">
				<tr>
				  <td width="180" class="t12g" > Plantilla a modificar</td>
				  <td width="180"><div align="left">
					  <select name="plt_jornada">
						<option value=""></option>
						<?php
						$query1 = mysql_query("SELECT * FROM plant WHERE cuenta='$cuentam' ORDER BY nombre_plantilla ASC");
						while ($registro = mysql_fetch_array($query1))
						{
						?>
			...
			<table width="210" border="0">
           		<tr><td width="100" class="comment"><div align="center" class="Estilo69">
...
<!-- MODIFICAR PLANTILLA POR SEMANA --> 

<form action="mod_plantilla_semana.php" method="post" name="form2" onSubmit="MM_validateForm('fecha','','R','ci','','RisNum');return document.MM_returnValue">
				...
				<?php
				$cuentam=$_COOKIE['usuario'];
				echo '<input name="cuenta" type="text" value="'.$_COOKIE['usuario'].'">';
				echo '<input name="llenado_semana" type="text" value=2>';
				?></p>
