...
<HTML>
<HEAD>
<TITLE>Datos iniciales para incluir Trabajador. Sistema ARTS Online</TITLE>
...
<!--
function enviar(){
var enviarme=confirm("¿Desea incluir este trabajador?");
if (enviarme)
   return true ;
else
   return false ;
			...
			<table width="526" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="508" bgcolor="#FFFFFF" class="t12b"><table width="101%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
						  ...
						  <form action="verifica_nuevo_traba.php" method="post" name="incluir_traba" class="Estilo25" id="incluir_traba">
                            <table id="tabla1" style="display:none" width="200" border="0">
                            </table>
                            <table width="383" height="174" border="1" id="tablaA">
                              <tr>
                                <td width="377" height="151"><p align="left" class="Estilo25">- Insertar Trabajador nuevo </p>
                                    <div align="center">
                                      <table width="364" height="90" border="0" id="tablatar">
                                        <tr>
                                          <td width="197" class="t12g">Grupo de trabajo</td>
                                          <td width="157"><div align="center" class="t12g"><strong>
                                            <select name="jefatura_traba" class="Estilo56">
<?php
include ("security_system.php");
ini_set('error_reporting',0);
...
switch($_SESSION['level']){
	...
	case 2:
	$tablaestructura = mysql_query("SELECT jefatura FROM estruct WHERE estructura='$estructura' ORDER BY jefatura ASC");
	break;
	
	case 3:
	$tablaestructura = mysql_query("SELECT jefatura FROM estruct WHERE coordinacion='$estructura' ORDER BY jefatura ASC");
	break;
	
	case 4:
	$tablaestructura = mysql_query("SELECT jefatura FROM estruct WHERE gerencia='$estructura' ORDER BY jefatura ASC");
	break;
	
	case 5:
	$tablaestructura = mysql_query("SELECT jefatura FROM estruct WHERE direccion='$estructura' ORDER BY jefatura ASC");
	break;
	
	case 6:
	$tablaestructura = mysql_query("SELECT * FROM estruct WHERE region='$estructura' ORDER BY jefatura ASC");
	break;
	
	case 7:
	$tablaestructura = mysql_query("SELECT * FROM estruct");
	break;
}

while ($registroestructura = mysql_fetch_array($tablaestructura)){
	?>
	<option value="<?php echo $registroestructura['jefatura']; ?>"><?php echo $registroestructura['jefatura']; ?></option>
	<?php
}
...
?>
                                        ...
                                        <tr>
                                          <td class="t12g"> C&Eacute;dula de identidad </td>
                                          <td><div align="center">
                                              <input name="ci" type="text" size="12" maxlength="12" onKeyPress="return validar2(event)" />
                                          </div></td>
                                        </tr>
                                        <tr>
                                          <td><div align="center">
                                              <input name="gen_tarjeta" type="submit" class="t12g" id="gen_tarjeta" onClick="enviar();MM_validateForm('ci','','RisNum');return document.MM_returnValue" value="Generar">
                                          </div></td>
                                          <td><div align="center">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		      <td height="8"><img src="images/index_57.gif" width=240 height=1 alt=""><div align="center" class="t12g"><span class="t14w Estilo30">Sistema ARTS                        </span></div>
		        <ul class="Estilo9 Estilo31"><li class="Estilo11"><a title="inicio.htm" href="inicio.html" target="_self">Inicio</a></li>
            ...
            <li class="Estilo11"><span class="Estilo10">Trabajadores
                </span>
              <ul>
            ...
            <li class="Estilo11"><span class="Estilo10">Jornadas
              </span>
              <ul>
            ...
            <li class="Estilo11"><span class="Estilo10">Menu Admin</span>
              <ul><li><strong>Trabajadores</strong>
                <ul><li><a title="consulta_trabaj.php" href="consulta_trabaj.php" target="_self">Consulta</a></li>
                        <li><a title="actualizar_trabaj.php" href="actualizar_trabaj.php" target="_self">Modificacion</a></li>
                        <li><a title="elim_traba.php" href="elim_traba.php" target="_self">Eliminacion</a></li>
                        <li><a title="menu_graficar_trabaj.php" href="menu_graficar_trabaj.php" target="_self">Graficacion</a></li>
                      </ul>
            ...
            <li class="Estilo11"><span class="Estilo10">FAQ
