...
function enviar(){
var enviarme=confirm("¿Desea consultar estos datos?");
if (enviarme)
   return true ;
else
   return false ;
...
<p>&nbsp;</p>
<div align="center">
							  <p><em><strong><font color="#009900"><u>Consulta de Trabajadores</u></font></strong></em></p>
							  <form action="consulta_ind_traba.php" method="post" name="buscar_trabajador" onSubmit="MM_validateForm('busca_cedula','','RisNum');return document.MM_returnValue">
                                <table width="200" border="1">
                                  <tr>
                                    <td><p align="center" class="Estilo25">Espec&iacute;fica por Identificaci&oacute;n </p>
                                      <table width="315" height="54" border="0">
                                        <tr>
                                          <td width="161"><div align="right" class="Estilo26">
                                            <div align="center" class="t12g">C&Eacute;dula de Identidad: </div>
                                          </div></td>
                                          <td width="144">
                                            <div align="center">
                                        ...
                                        <tr>
                                          <td><div align="center">
                                            <input name="busca_trabaj" type="submit" class="t12g" id="busca_trabaj" onClick="MM_validateForm('ci','','R');enviar();return document.MM_returnValue" value="Buscar">
                                          </div></td>
                                          <td><div align="center">
							  ...
							  <form action="consulta_gral_traba.php" method="post" name="buscar_estructura" class="Estilo25" id="buscar_estructura">
							    General Por Estructuras
							    <table width="172" border="0">
                                  <tr>
                                    <td width="166" class="t12g">
<input name="radiobutton" type="radio" value="6" onClick="viewHide('tabla6')">                                    
Regi&Oacute;n</td>
                                  </tr>
                                  <tr>
                                    <td class="t12g">
									<input name="radiobutton" type="radio" value="5" Onclick="viewHide('tabla5')">                                    
                                    Direcci&Oacute;n</td>
                                  </tr>
                                  <tr>
                                    <td class="t12g">
									<input name="radiobutton" type="radio" value="4" Onclick="viewHide('tabla4')">
                                    Gerencia</td>
                                  </tr>
                                  <tr>
                                    <td class="t12g">
									<input name="radiobutton" type="radio" value="3" Onclick="viewHide('tabla3')">
                                    Coordinaci&oacute;n</td>
                                  </tr>
                                  <tr>
                                    <td class="t12g">
									<input name="radiobutton" type="radio" value="2" Onclick="viewHide('tabla2')">                                    
                                    Departamento</td>
                                  </tr>
                                  <tr>
                                    <td class="t12g">
									<input name="radiobutton" type="radio" value="1"Onclick="viewHide('tabla1')">
									Jefatura</td>
                                  </tr>
                                </table>
...
?>
	  ...
	  <table width="5" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  <td class="t14w Estilo29"><img src="images/index_57.gif" width=240 height=1 alt=""></td>
		</tr>
	  </table>
	  ...
	  <div align="center" class="t12g">
        <p class="t14w Estilo29">Sistema ARTS</p>
        </div>
      <ul class="Estilo9">
        <li class="t12w Estilo27"><a title="inicio.htm" href="inicio.html" target="_top">Inicio</a></li>
        <li class="t12w Estilo27"><a title="antecedentes.htm" href="antecedentes.htm" target="_top">Antecedentes</a></li>
        <li class="t12w Estilo27"><a title="Objetivos.html" href="Objetivos.html" target="_top">Objetivos</a></li>
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Trabajadores 
            </span>
          <ul>
              <li class="Estilo28"><a title="cargar_traba.php" href="cargar_traba.php" target="_self">Inclusion - Carga</a></li>
              <li class="Estilo28"><a title="consulta_trabaj.php" href="consulta_trabaj.php" target="_self">Consulta - Reporte</a></li>
              <li class="Estilo28"><a title="actualizar_trabaj.php" href="actualizar_trabaj.php" target="_self">Modificacion</a></li>
              <li class="Estilo28"><a title="elim_traba.php" href="elim_traba.php" target="_self">Eliminacion</a></li>
              <li class="Estilo28"><a title="menu_graficar_trabaj.php" href="menu_graficar_trabaj.php" target="_self">Graficacion</a></li>
            </ul>
        </li>
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Jornadas 
            </span>
          <ul>
              <li class="Estilo28"><a title="cargar_jornada.html" href="cargar_jornada.php" target="_self">Inclusion - Carga</a></li>
              <li class="Estilo28"><a title="consulta_jornada.php" href="consulta_jornada.php" target="_self">Consulta - Reporte</a></li>
              <li class="Estilo28"><a title="actualizar_jornada.php" href="actualizar_jornada.php" target="_self">Modificacion</a></li>
              <li class="Estilo28"><a title="delete_jornada.php" href="delete_jornada.php" target="_self">Eliminacion</a></li>
              <li class="Estilo28"><a title="menu_graficar_jornada.php" href="menu_graficar_jornada.php" target="_self">Graficacion</a></li>
            </ul>
        </li>
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">Menu Admin
          ...
          <ul>
              ...
              <li><span class="Estilo28"><strong>Usuarios </strong>
                ...
                <ul>
                    <li class="Estilo28"><a title="cargar_user.php" href="cargar_user.php" target="_self">Inclusion - Carga</a></li>
                    <li class="Estilo28"><a title="consulta_user.php" href="consulta_user.php" target="_self">Consulta - Reporte</a></li>
                    <li class="Estilo28"><a title="actualizar_user.php" href="actualizar_user.php" target="_self">Modificacion</a></li>
                    <li class="Estilo28"><a title="elim_user.php" href="elim_user.php" target="_self">Eliminacion</a></li>
                    <li class="Estilo28"><a title="menu_graficar_user.php" href="menu_graficar_user.php" target="_self">Graficacion</a></li>
                  </ul>
              </li>
              <li class="Estilo28"><a title="consulta_jornada.php" href="consulta_jornada.php" target="_self">Consulta - Reporte</a></li>
              <li class="Estilo28"><a title="actualizar_jornada.php" href="actualizar_jornada.php" target="_self">Modificacion</a></li>
              <li class="Estilo28"><a title="elim_jornada.php" href="elim_jornada.php" target="_self">Eliminacion</a></li>
            </ul>
        </li>
        <li class="t12w Estilo27"><a title="download.html" href="download.html" target="_self">Descargas</a></li>
        <li class="t12w Estilo27"><a href="menu_sarts.html">Sistema ARTS </a></li>
        <li class="t12w Estilo27">Contacto SARTS</li>
        <li class="Estilo11 Estilo26 Estilo27"><span class="Estilo28">FAQ 
            </span>
          <ul>
              <li class="Estilo28">Preguntas Generales</li>
              <li class="Estilo28">Manual de Usuario</li>
            </ul>
        </li>
        <li class="t12w Estilo27">Ayuda Online (proximamente)</li>
        <li class="t12w Estilo27">Forums (proximanete)</li>
        </ul>
      <div align="left">
