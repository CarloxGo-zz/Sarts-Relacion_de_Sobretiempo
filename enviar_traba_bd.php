...
.Estilo1 {font-weight: bold; text-transform: uppercase; color: 069300; text-decoration: none; font-size: 12px;}
.Estilo2 {text-transform: uppercase; color: 069300; text-decoration: none; font-weight: bold;}
.Estilo3 {text-decoration: none; font-weight: bold; text-transform: uppercase;}
-->
</style>
</HEAD>
</HTML>
...
<td colspan="2" valign="middle"><div align="center"> 
  ...
  <tr>
	<td align="right" background="images/index_01.gif"><img src="images/index_03.gif" width=59 height=34 alt=""><a href="index.html"><img src="images/index_ini.gif" alt="" width=82 height=34 border="0"></a><img src="images/index_faq.GIF" width=82 height=34 alt=""><img src="images/index_link.gif" width=89 height=34 alt=""><a href="menu_sarts.html"><img src="images/index_sarts.gif" alt="" width=71 height=34 border="0"></a><img src="images/index_contac.GIF" width=85 height=34 alt=""></td>
  </tr>
</table>
<table width="778" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<table width="778" border="0" cellspacing="0" cellpadding="0">
  <tr>
	<td width="450" background="mages/index_23.gif"><img src="images/index_22.gif" width=174 height=35 alt=""></td>
	<td background="images/index_27.gif"><p><img src="images/index_25.jpg" width=96 height=35 alt=""><img src="images/index_soft.GIF" width=92 height=35 alt=""></p></td>
  </tr>
</table>
		  ...
		  <td width="507" valign="top" class="bg_product"> 
			<table width="526" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="508" bgcolor="#FFFFFF" class="t12b"><table width="101%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td height="471" align="center" bgcolor="#FFFFFF"><div id="Layer1">
...
$sql="INSERT INTO trabaj (ci,nombres,apellidos,estructura,jefatura,cargo,horario,estatus) VALUES('$ci','$nombres','$apellidos','$estructura','$jafatura','$cargo','$horario','$estatus')";
...
?>
							...
							<p>&nbsp;</p>
                              <h2><font color="#FF0000" size="5" face="Times New Roman, Times, serif"><span class="Estilo3">Datos del trabajador enviados satisfactoriamente</span>
                              </font> </h2>
                              <p>&nbsp;</p>
                              </form>
                            </div>
