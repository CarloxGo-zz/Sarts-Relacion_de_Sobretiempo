...
if($_POST['nombre_plantilla']=="")
{
?>
	<span class="Estilo36"><u>Atenci&oacute;n</u></span></p>
	<p><span class="Estilo36">No se Modific&oacute; ninguna Plantilla </span></p>
	<p><span class="Estilo36">porque no se  encontr&oacute; ese nombre </span></p>
	<p>
<?php
}else{

$nombre_plantillam=$_POST['nombre_plantilla'];
$cuentam=$_COOKIE['usuario'];
	...
	$sql = "Update plantillas Set cuenta='$cuentam',nombre_plantilla='$nombre_plantilla',dia='$diam',hd='$hdm',hed='$hedm',hedp='$hedpm',trcd='$trcdm',bonocturno='$bonocturnom',hen='$henm',henp='$henpm',trcn='$trcnm',clave221='$clave221m',clave277='$clave277m' where nombre_plantilla='$nombre_plantilla' and dia='$cont'") ;
...
?>
                          ...
                          <p>&nbsp;</p>
							<div align="center"> <span class="t12g Estilo30"><span class="Estilo34">&iquest;Desea modifCAR otra plantilla?
                              </p>
                                </span></span>
                                  ...
                                  <tr>
                                    <td width="113"><div align="center"><font color="#FF0000" size="2"><a title="Ayuda sobre el manejo del SARTS" href="#">
                                      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="103" height="24">
                                        ...
                                        <param name="movie" value="button44.swf">
                                        <param name="quality" value="high">
                                        <embed src="button44.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="103" height="24" ></embed>
                                      </object>
                                    </a></font></div></td>
...
<ul class="Estilo9"><li class="Estilo11 Estilo48"><a title="inicio.htm" href="inicio.html" target="_self">Inicio</a></li>
	...
	<ul>
		...
		<li><a title="Menú Gráfica datos trabajador " href="menu_graficar_trabaj.php" target="_self">Graficaci&oacute;n</a></li>
    	</ul></ul>
	...
	<li><strong>Usuarios</strong>
		...
		<li><a title="Próximanmente" href="consulta_user.php" target="_self">Consulta - Reporte</a></li>
		<li><a title="Próximanmente" href="actualizar_user.php" target="_self">Modificaci&oacute;n</a></li>
		<li><a title="Próximanmente" href="elim_user.php" target="_self">Eliminaci&oacute;n</a></li>
		<li><a title="Próximanmente" href="menu_graficar_user.php" target="_self">Graficaci&oacute;n</a></li>
		</ul></li>
		</ul>
	<li class="Estilo48"><strong>Adicionales</strong>
		...
		<li class="Estilo11 Estilo48"><a title="Menú SARTS" href="menu_sarts.html">Sistema ARTS</a></li>
