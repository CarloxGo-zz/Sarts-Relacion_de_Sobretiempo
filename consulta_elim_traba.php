...
function enviar(){
var enviarme=confirm("Desea proceder a la eliminacion?");
if (enviarme)
   return true ;
else
   return false ;
...
if(mysql_num_rows($result)==0)
{
	...
	echo '<tr>';
	echo '<td align="center"><input type="submit" name="regresar" onclick="enviar()" value="Regresar" style="background:#FFB400" lang="es" maxlength="30"></td>';
	echo '</tr>';
	echo '</table>';
	echo '</div>';
}else{
	...
	echo '<center>';
	echo "<H3><font color='green'>Datos del Trabajador</font></H3>";
	echo "<center><table border = '1' bgcolor='#ffffff'> \n";
	while ($row=mysql_fetch_array($result))
	{
				echo '<input name="cedul" type="hidden" value="'.$ci.'">';
				echo '<table width="330" border="0" align="center">';
				echo '<tr>';
	...
	echo '<table width="200" border="0">';
	echo "<p>&nbsp;</p>";
	echo "&iquest;Desea eliminar los datos de este trabajador?";
	echo '<tr>';
	echo '<td><input type="submit" name="si" value ="Si" style="background:#FFB400" lang="es" maxlength="30"></td>';
	echo '<td><input type="submit" name="no" value ="No" style="background:#FFB400" lang="es" maxlength="30"></td>';
	echo '</tr>';
	echo '</table>';
	echo '</div>';
}	
