...
<HTML>
<HEAD>
<TITLE>Consulta para Eliminar Datos de Trabajador. Sistema ARTS Online</TITLE>
...
<p><em><strong><font color="#009900"><u>Eliminar Trabajador</u></font></strong></em></p>
<div align="center">
  <form action="consulta_elim_traba.php" method="post" name="buscar_trabajador" onSubmit="MM_validateForm('busca_cedula','','RisNum');return document.MM_returnValue">
                                <table width="200" border="10">
                                  <tr>
                                    <td><p align="center" class="Estilo25">Identificaci&oacute;n</p>
                                      <table width="315" height="54" border="0">
                                        <tr>
                                          <td width="161"><div align="right" class="t12g">
                                            <div align="center">C&Eacute;dula de Identidad: </div>
                                          </div></td>
                                          <td width="144">
                                            <div align="center">
...
<h1 align="right">
	  ...
	  </table><div align="center" class="t12g">
        <p class="t12g Estilo26 Estilo27">Sistema ARTS </p>
        </div>
      <ul class="Estilo9">
        <li class="Estilo11 Estilo26"><a title="inicio.htm" href="inicio.html" target="_top">Inicio</a></li>
        <li class="Estilo11 Estilo26"><a title="antecedentes.htm" href="antecedentes.htm" target="_top">Antecedentes</a></li>
        <li class="Estilo11 Estilo26"><a title="Objetivos.html" href="Objetivos.html" target="_top">Objetivos</a></li>
        <li class="Estilo11 Estilo26"><span class="Estilo10">Trabajadores </span>
            <ul>
        ...
        <li class="Estilo11 Estilo26"><span class="Estilo10">Jornadas </span>
            <ul>
        ...
        <li class="Estilo11 Estilo26"><span class="Estilo10">Menu Admin</span>
            <ul>
        ...
        <li class="Estilo11 Estilo26"><a title="download.html" href="download.html" target="_self">Descargas</a></li>
        <li class="Estilo11 Estilo26"><a href="menu_sarts.html">Sistema ARTS </a></li>
        <li class="Estilo11 Estilo26">Contacto SARTS</li>
        <li class="Estilo11 Estilo26"><span class="Estilo10">FAQ </span>
            <ul>
              <li>Preguntas Generales</li>
              <li>Manual de Usuario</li>
            </ul>
        </li>
        <li class="Estilo11 Estilo26">Ayuda Online (proximamente)</li>
        <li class="Estilo11 Estilo26">Forums (proximanete)</li>
        </ul>
      <div align="left">
